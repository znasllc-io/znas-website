  ...
  en: {
    ...
    proposals: {
      ...
      viewer: {
        ...
        tryNow: "Try Now",
        tryNowHint: "Launch a live, interactive preview of your new portal. It runs right here on the page.",
  ...
  es: {
    ...
    proposals: {
      ...
      viewer: {
        ...
        tryNow: "Probar Ahora",
        tryNowHint: "Abre una vista previa interactiva de tu nuevo portal. Funciona aquí mismo en la página.",
